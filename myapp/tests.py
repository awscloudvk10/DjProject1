...
class MySeleniumTests(StaticLiveServerTestCase):
    ...
    def tearDownClass(cls):
        # tanquem browser
        # comentar la propera l nia si volem veure el resultat de l'execuci  al navegador
        cls.selenium.quit()
        super().tearDownClass()
 
    def test_login(self):
        # anem directament a la p gina d'acc s a l'admin panel
        self.selenium.get('%s%s' % (self.live_server_url, '/admin/login'))
 
        # comprovem que el t tol de la p gina  s el que esperem
        self.assertEqual( self.selenium.title , "Log in | Django site admin" )
 
        # introdu m dades de login i cliquem el bot  "Log in" per entrar
        ...
        # testejem que hem entrat a l'admin panel comprovant el t tol de la p gina
